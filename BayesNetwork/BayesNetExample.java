...
public class BayesNetExample {
	...
	public BayesNetExample() {
		...
		InferenceGraphNode smoker = BayesNetHelper.createNode(inferenceGraph, "smoker", "smokes", "doesnotsmokes");
		...
		BayesNetHelper.setProbabilityValues(surgical, "doesnotsmokes", "<2Y", 0.8, 0.2);
		BayesNetHelper.setProbabilityValues(surgical, "doesnotsmokes", ">2Y", 0.58, 0.42);
		...
		belief = BayesNetHelper.getBelief(inferenceGraph, surgical);
		System.out.println("The probability of surgery being positive for a smoker, younger than 55 "
				+ "with symptoms over 2 years: " + belief);
